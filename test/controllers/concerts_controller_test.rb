...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { crowd: @concert.crowd, date: @concert.date, group_id: @concert.group_id, name: @concert.name } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { crowd: @concert.crowd, date: @concert.date, group_id: @concert.group_id, name: @concert.name } }
